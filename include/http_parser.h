/* Taken from https://www.boost.org/doc/libs/1_74_0/libs/beast/doc/html/beast/using_http/custom_parsers.html 
to create an instance of a parser that can parse
requests and responses of http format from basic_parser.h in the boost/beast libary vs.1.74*/
...
class http_parser : public http::basic_parser<isRequest> {
public:
    ...
    */
    void
    on_request_impl(
        http::verb method,                // The method verb, verb::unknown if no match
    ...
    */
    void
    on_field_impl(
        http::field f,                    // The known-field enumeration constant
